...
python simple_inference_demo.py     --input /mnt/chengchangxu/data/VSI-Bench/arkitscenes/41254386.mp4    --question "What is the length of the longest dimension (length, width, or height) of the toilet, measured in centimeters?"
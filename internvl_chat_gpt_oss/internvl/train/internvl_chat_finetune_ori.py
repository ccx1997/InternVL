...
# use_tcs_loader = bool(os.environ.get("USE_TCS_LOADER", "0"))  Todo: 需要改回来
...
class LazySupervisedDataset(Dataset):
    ...
    def video_get_item(self, data_item):
        ...
        # Generate special tokens for each video frame
        # TODO20250827: 原版代码没有+3/4的操作, 看一下上一步image_list的长度
    ...
    def __iter__(self):
        logger.info(f"__iter__ called for dataset={self.ds_name}")
        self._enable_worker_distributed()
        start_idx = 0
